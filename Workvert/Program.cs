...
{
    client.DefaultRequestHeaders.UserAgent.ParseAdd("Mozilla/5.0 (compatible; Workvert/1.0; +https://workvert.local)");
...
builder.Services.AddHttpClient<IUrlCampaignBriefSuggester, UrlCampaignBriefSuggester>(client =>
{
    ...
    client.DefaultRequestHeaders.UserAgent.ParseAdd("Mozilla/5.0 (compatible; WorkvertUrlAnalyzer/1.0)");
    client.DefaultRequestHeaders.Accept.ParseAdd("text/html");
});
builder.Services.AddHttpClient<ILeadDiscoveryService, LeadDiscoveryService>(client =>
{
    client.Timeout = TimeSpan.FromSeconds(12);
    client.DefaultRequestHeaders.UserAgent.ParseAdd("Mozilla/5.0 (compatible; WorkvertLeadDiscovery/1.0)");
    client.DefaultRequestHeaders.Accept.ParseAdd("text/html");
});
