...
public sealed class AlertDispatcher : IAlertDispatcher
{
        ...
        try
        {
            ...
            return channel.ToUpperInvariant() switch
            {
                ...
                "TIKTOK" or "INSTAGRAM" or "FACEBOOK" or "LINKEDIN" or "SMS" =>
                    Skip(log, $"Channel '{channel}' is not part of the Workvert price-alert workflow."),
        ...
        CancellationToken ct)
    {
        ...
        var payload = new
        {
            content = Truncate($"**Workvert price alert**\n{message}", 1900),
        ...
        CancellationToken ct)
    {
        ...
        var payload = new
        {
            text = Truncate($"Workvert price alert\n{message}", 2900)
        };
        ...
        CancellationToken ct)
    {
        ...
        var payload = new Dictionary<string, object>
        {
            ...
            ["summary"] = "Workvert price alert",
            ["themeColor"] = "22c55e",
            ["title"] = "Workvert price alert",
        ...
        CancellationToken ct)
    {
        ...
        for (var index = 0; index < recipients.Count; index++)
        {
            ...
            using var mail = new MailMessage
            {
                ...
                Subject = Truncate($"Workvert price alert - {snapshot.ProductName ?? alert.Symbol}", 120),
